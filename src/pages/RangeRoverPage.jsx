...
const PARTNERSHIPS = [
  {
    title: 'SV BESPOKE COMMISSIONING',
    desc: 'Collaborate with JLR master designers at the SV Technical Centre to create a one-of-a-kind vehicle with bespoke materials, custom paints, and embroidered leather.',
    bg: '#0f1115'
  },
  {
    title: 'ROYAL WINDSOR HORSE SHOW',
    desc: 'Celebrating high-society equestrian excellence and timeless tradition as the official automotive partner for over three decades.',
    bg: '#16191f'
  },
  {
    title: 'DESIGN BIENNALE COLLABORATIONS',
    desc: 'Exploring the intersections of architectural form, clean minimalist styling, and future-forward material sciences with modern artists.',
    bg: '#0f1115'
  }
];
...
export default function RangeRoverPage() {
  ...
  return (
    <div style={{ backgroundColor: '#000000', color: 'var(--jlr-white)', minHeight: '100vh', width: '100vw' }}>
      ...
      >
        THE PINNACLE OF PERSONALIZATION. THE NEW RANGE ROVER SV COMMISSIONING SUITE IS NOW OPEN.
      </div>
      ...
      <VehicleConfigurator isOpen={isConfiguratorOpen} onClose={closeConfigurator} initialBrand="rangerover" />
      ...
      >
        ...
        >
          ...
          >
            A breathtaking modernist silhouette. Sophisticated interiors offering absolute cabin calmness and refined command of the road.
          </p>
      ...
      >
        <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', gap: '30px', alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '0.7rem', color: 'var(--jlr-light-grey)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>LEGACY</div>
            <div style={{ fontSize: '1rem', fontWeight: 600, letterSpacing: '0.1em', marginTop: '6px', color: 'var(--jlr-accent)' }}>50+ YEARS OF PEERLESS PRESTIGE</div>
          </div>
          <div style={{ height: '30px', width: '1px', backgroundColor: 'rgba(255,255,255,0.1)', display: 'none', md: 'block' }} />
          <div>
            <div style={{ fontSize: '0.7rem', color: 'var(--jlr-light-grey)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>ARCHITECTURE</div>
            <div style={{ fontSize: '1rem', fontWeight: 600, letterSpacing: '0.1em', marginTop: '6px' }}>MLA-FLEX LUXURY ALUMINUM BODY</div>
          </div>
          <div style={{ height: '30px', width: '1px', backgroundColor: 'rgba(255,255,255,0.1)', display: 'none', md: 'block' }} />
          <div>
            <div style={{ fontSize: '0.7rem', color: 'var(--jlr-light-grey)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>EXCLUSIVITY</div>
            <div style={{ fontSize: '1rem', fontWeight: 600, letterSpacing: '0.1em', marginTop: '6px' }}>SV TECHNICAL COMMISSIONING</div>
          </div>
        </div>
      </section>
        ...
        <div style={{ padding: '0 40px', marginBottom: '60px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '20px' }}>
          <div>
            <div style={{ fontSize: '0.75rem', color: 'var(--jlr-accent)', letterSpacing: '0.25em', textTransform: 'uppercase', marginBottom: '8px' }}>
              CHOOSE YOUR BODY AND POWER STYLE
            </div>
            <h2 style={{ fontSize: '2rem', letterSpacing: '0.15em', margin: 0 }}>THE RANGE ROVER FAMILY</h2>
          </div>
      ...
      <section style={{ padding: '100px 0', backgroundColor: '#07080b', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <SpecsComparison brand="rangerover" />
      </section>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '60px' }}>
          <div style={{ flex: '1 1 400px' }}>
            ...
            <p style={{ color: 'var(--jlr-light-grey)', fontSize: '0.95rem', lineHeight: '1.7', marginBottom: '20px' }}>
              The Range Rover is constructed using JLR's pioneering Modular Longitudinal Architecture (MLA-Flex). MLA-Flex incorporates intelligent acoustic design and advanced mixed-metal structural composites to insulate the passenger compartment from noise and vibration, providing the ultimate expression of quiet luxury.
            </p>
            <div style={{ borderLeft: '2px solid var(--jlr-accent)', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <div>
                <strong style={{ display: 'block', fontSize: '0.9rem', color: '#fff' }}>All-Wheel Steering</strong>
                <span style={{ fontSize: '0.8rem', color: 'var(--jlr-light-grey)' }}>Electrically controlled rear axle pivots up to 7.3° to improve low-speed maneuverability.</span>
              </div>
              <div>
                <strong style={{ display: 'block', fontSize: '0.9rem', color: '#fff' }}>Adaptive Air Suspension</strong>
                <span style={{ fontSize: '0.8rem', color: 'var(--jlr-light-grey)' }}>Pre-emptive chassis calibration reads e-navigation data to soften dampers before curves.</span>
              </div>
            </div>
          </div>
          <div style={{ flex: '1 1 500px', width: '100%' }}>
            <Chassis3DAnimation activeColor="var(--jlr-accent)" brandTitle="Range Rover MLA-Flex Platform" />
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', width: '100%' }}>
          ...
          >
            <div>
              ...
              <p style={{ color: 'var(--jlr-light-grey)', fontSize: '0.95rem', lineHeight: '1.7', maxWidth: '500px' }}>
                Select paint configurations, leather options, interior veneers, technology add-ons, and alloy wheels to design your customized Range Rover.
              </p>
            </div>
            <div>
              <button
              ...
              >
                Launch Commissioning Suite <ArrowRight size={16} />
              </button>
            </div>
          </div>
          ...
          >
            <div>
              ...
              <h2 style={{ fontSize: '2rem', letterSpacing: '0.15em', marginBottom: '20px' }}>REQUEST CONSULTATION</h2>
              <p style={{ color: 'var(--jlr-light-grey)', fontSize: '0.95rem', lineHeight: '1.7', maxWidth: '500px', marginBottom: '24px' }}>
                Schedule a priority walkthrough session at our Range Rover technical center or request a private home vehicle showcase.
              </p>
              ...
              {testDriveBooked ? (
                ...
                >
                  <strong>Consultation Slot Requested!</strong> Hello {tdName}, our JLR Concierge Desk will contact you at {tdPhone} to confirm your bespoke service selection.
                </div>
              ) : (
      ...
      >
        <div style={{ padding: '0 40px', marginBottom: '50px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '20px' }}>
          <div>
            <div style={{ fontSize: '0.75rem', color: 'var(--jlr-accent)', letterSpacing: '0.25em', textTransform: 'uppercase', marginBottom: '8px' }}>
              LUXURY COLLABORATIONS & EVENTS
            </div>
            <h2 style={{ fontSize: '2rem', letterSpacing: '0.15em', margin: 0 }}>RANGE ROVER LIFE</h2>
          </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', gap: '60px', marginBottom: '80px' }}>
          ...
          <div style={{ flex: '1 1 350px' }}>
            ...
            <p style={{ color: 'var(--jlr-light-grey)', fontSize: '0.85rem', marginBottom: '24px', lineHeight: '1.6' }}>
              Sign up for notifications regarding Range Rover technical launches, luxury expeditions, and bespoke limited-edition releases.
            </p>
            ...
            {newsletterSubscribed ? (
              ...
              >
                Thank you! You have been successfully added to our luxury priority briefing list.
              </div>
            ) : (
          ...
          <div style={{ flex: '2 1 500px', display: 'flex', flexWrap: 'wrap', gap: '40px', justifyContent: 'space-between' }}>
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.8rem', color: 'var(--jlr-light-grey)' }}>
                <li><a href="#explore">Range Rover SV</a></li>
                <li><a href="#explore">Range Rover Sport</a></li>
                <li><a href="#explore">Range Rover Velar</a></li>
                <li><a href="#explore">Range Rover Evoque</a></li>
              </ul>
            </div>
            <div>
              <h4 style={{ fontSize: '0.75rem', color: 'var(--jlr-white)', letterSpacing: '0.15em', marginBottom: '18px' }}>OWNERSHIP</h4>
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.8rem', color: 'var(--jlr-light-grey)' }}>
                <li><a href="#explore">Roadside Concierge</a></li>
                <li><a href="#explore">SV Bespoke Service</a></li>
                <li><a href="#explore">SV Warranty Program</a></li>
                <li><a href="#explore">Premium JLR Finance</a></li>
              </ul>
            </div>
            <div>
              <h4 style={{ fontSize: '0.75rem', color: 'var(--jlr-white)', letterSpacing: '0.15em', marginBottom: '18px' }}>EXPERIENCE</h4>
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.8rem', color: 'var(--jlr-light-grey)' }}>
                <li><a href="#partnerships">SV Technical Center</a></li>
                <li><a href="#partnerships">Windsor Horse Show VIP</a></li>
                <li><a href="#partnerships">Design Biennale Salon</a></li>
